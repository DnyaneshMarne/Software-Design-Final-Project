...
class GameWindow:
    ...
    def __init__(self) -> None:
        ...
        if GameWindow.__instance != None:
            ...
            self._canvas = Canvas(self._window, width = 700, height = 700, background = "#10104E")
            img = (Image.open("Background.png"))
            resized_image= img.resize((700,600), Image.LANCZOS)
    ...
    def run(self):
        ...
        if self.startgame :
            ...
            self._window.after(self.framerate,self.Obstacles.batObs)
            self._window.after(self.framerate,self.Obstacles.batMotion)
